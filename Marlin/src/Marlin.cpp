...
void setup() {
  ...
  stepper.init();    // Initialize stepper, this enables interrupts!
    ...
    SET_OUTPUT(SPINDLE_FWD_PIN);
    OUT_WRITE(SPINDLE_FWD_PIN, !SPINDLE_INVERT_DIR);  // init spindle to off
    #if SPINDLE_DIR_CHANGE
      SET_OUTPUT(SPINDLE_REV_PIN);
      OUT_WRITE(SPINDLE_REV_PIN, !SPINDLE_INVERT_DIR);
    #endif
