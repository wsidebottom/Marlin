 ...
 */
  ...
  #if !PIN_EXISTS(SPINDLE_FWD)
    #error "SPINDLE_LASER_ENABLE requires SPINDLE_FWD_PIN."
  #elif SPINDLE_DIR_CHANGE && !PIN_EXISTS(SPINDLE_REV)
    #error "SPINDLE_REV_PIN not defined."
